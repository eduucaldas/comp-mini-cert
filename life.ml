...
let print_graph_with_life fmt body entry =
  let label_live = liveness body in
Ertltree.visit (fun l i -> fprintf fmt "%a: %a " Label.print l print_instr i; print_live_info fmt (Hashtbl.find label_live l)) body entry
